...
gglili: Simple Single Golang Web Service

go-crud正式改名为gglili!

使用gglili开发Web服务: 用最简单的架构，实现够用的框架，服务海量用户

https://github.com/Gourouting/gglili
...
gglili框架为移动端提供Token登录的案例: https://github.com/bydmm/gglili-token-exmaple
## 目的
